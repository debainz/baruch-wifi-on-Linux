...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "City University of New York"
Config.profilename = "CUNY TTLS+PAP"
Config.url = " \
    ""https://cunyithelp.cuny.edu/csp?id=search&spa=1&q=eduroam"
Config.email = "your local eduroam® support"
Config.title = "eduroam CAT"
Config.server_match = "ims-radius01.cuny.edu"
...
Config.user_realm = "login.cuny.edu"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:ims-radius01.cuny.edu']
Config.use_other_tls_id = False
Config.anonymous_identity = "anon@login.cuny.edu"
